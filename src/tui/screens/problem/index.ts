...
export function update(
  ...
  switch (msg.type) {
    ...
    case 'PROBLEM_TEST':
      return [
        { ...model, isRunning: true, testResult: null, submissionResult: null },
    ...
    case 'PROBLEM_TEST_RESULT':
      return [
        { ...model, isRunning: false, testResult: msg.result, submissionResult: null },
        Cmd.none(),
      ];

    case 'PROBLEM_SUBMIT_RESULT':
      return [
        { ...model, isRunning: false, testResult: null, submissionResult: msg.result },
        Cmd.none(),
      ];
    ...
    case 'PROBLEM_SUBMISSIONS_ERROR':
      return [
        { ...model, submissionsLoading: false, showSubmissions: false, error: msg.error },
        Cmd.none(),
      ];
    ...
    case 'PROBLEM_SUBMISSIONS_SCROLL_UP':
      return [
        { ...model, submissionScrollOffset: Math.max(0, model.submissionScrollOffset - 1) },
        Cmd.none(),
      ];
    ...
    case 'PROBLEM_SHOW_SNAPSHOTS': {
      ...
      return [
        { ...model, showSnapshots: true, snapshotsList: snapshots, snapshotCursor: 0 },
        Cmd.none(),
      ];
    }
    ...
    case 'PROBLEM_DIFF_LOADED':
      return [
        { ...model, diffContent: msg.content, showDiff: true, diffScrollOffset: 0 },
        Cmd.none(),
      ];
